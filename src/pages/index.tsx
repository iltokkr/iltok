  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="Description" content="국내 1위 조선동포 및 교포 구인구직 플랫폼, 114114KR에서 쉽고 빠른 구직 서비스와 간편한 지역정보를 한 번에 확인하세요! 신속하고 정확한 114114구인구직 정보를 제공하는 플랫폼입니다. 조선동포, 재외동포, 해외교포를 위한 맞춤형 일자리 정보를 제공합니다. 아르바이트부터 경력직 채용, 일당, 주급, 월급까지 다양한 채용 정보를 손쉽게 확인하고 취업 기회를 찾으세요. 기업 채용 공고 무료 등록, 지역별 맞춤 구직 서비스, 헤드헌팅 서비스까지, 동포 여러분의 취업과 채용의 모든 것을 지원합니다." />
